...
WEATHER_FILE = Path(r"E:\NexgenAI\work\src\Ingestion\Data_json\weather_cleaned.json")
WINE_FILE = Path(r"E:\NexgenAI\work\src\Ingestion\Data_json\Wine_train.json")
MERGED_FILE = Path(r"E:\NexgenAI\work\src\Ingestion\Data_json\merged_data.json")
